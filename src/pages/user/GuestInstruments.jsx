...
const GuestInstruments = () => {
  ...
  useEffect(() => {
    getGuestAllInstrumentsData({});
  }, []);

  const getGuestAllInstrumentsData = async (queryVal = {}) => {
    try {
      const body = {
        query: queryVal,
        projection: {},
      ...
      const response = await api.post("/admin/guestallinstumnts", body);
  ...
  useEffect(() => {
    ...
    getGuestAllInstrumentsData(queryObj);
  }, [search]);
...
export default GuestInstruments;
